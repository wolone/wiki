...
| --------------- | --------- | ---------- | --- | ---- | ------- | ----- | --------------------- |
| [spell_id][1]   | MEDIUMINT | UNSIGNED   | PRI | NO   | 0       |       | 法术 id               |
...
法术 ID。参见 [Spell.dbc](spell_dbc)。

### attributes

来自 SpellInfo.h 中枚举 SpellCustomAttributes 的法术自定义属性。
...
| SPELL_ATTR0_CU_SHARE_DAMAGE                  | 8          | 0x00000008 | 流星类法术（在所有目标之间分摊伤害）                                   |
...
| SPELL_ATTR0_CU_SINGLE_AURA_STACK             | 4194304    | 0x00400000 | 所有来源都为同一光环叠加层数                                          |
...
| SPELL_ATTR0_CU_ONLY_ONE_AREA_AURA            | 536870912  | 0x20000000 | 只能同时存在 1 个持续性区域光环（例如玛洛加尔的冷焰）                 |
