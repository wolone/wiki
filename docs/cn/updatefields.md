...
**块值 3：** OBJECT_FIELD_ENTRY：creature_template.entry、gameobject_template.entry
**块值 4：** OBJECT_FIELD_SCALE_X：creature_template.size、gameobject_template.size
...
来源：https://trinitycore.atlassian.net/wiki/spaces/tc/pages/2129942/UpdateFields
