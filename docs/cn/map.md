...
| ---- | ----------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------- |
| 1    | ID                                                    | Integer |                                                                                                           |
| 2    | InternalName                                          | String  | 引用 World\\Map\\ \[...\] \\                                                                               |
| 3    | Flags                                                 | Integer | 0x100 - CAN\_CHANGE\_PLAYER\_DIFFICULTY                                                                    |
| 4    | Type                                                  | Integer | 0：无，1：小队，2：团队，3：PVP，4：竞技场，>=5：无（官方来自 "IsInInstance()"）                            |
| 5    | IsBattleground                                        | Integer | 布尔值（1 = 是，0 = 否）                                                                                   |
| 6-22 | Name                                                  | String  | [本地化](https://wowdev.wiki/Localization)；例如显示在世界地图上                                            |
| 23   | [AreaTableID](https://wowdev.wiki/DB/AreaTable)       | Integer | 引用 ID；                                                                                                 |
| 24-40 | MapDescriptionA                                       | String  | [本地化](https://wowdev.wiki/Localization)                                                                 |
| 41-57 | MapDescriptionH                                       | String  | [本地化](https://wowdev.wiki/Localization)                                                                 |
| 58   | [LoadingScreen](https://wowdev.wiki/DB/LoadingScreens) | Integer | 引用 ID；要显示的加载画面                                                                                 |
| 59   | BGMapIconScale                                        | Float   |                                                                                                           |
| 60   | GhostEntranceMap                                      | Integer | 引用 ID；指向第 1 列，如果没有则为 -1                                                                     |
| 61   | GhostEntranceX                                        | Float   | 副本入口的 X 坐标                                                                                          |
| 62   | GhostEntranceY                                        | Float   | 副本入口的 Y 坐标                                                                                          |
| 63   | TimeOfDayOverride                                     | Integer | 除奥格瑞玛和达拉然竞技场外，均设置为 -1。对于这些地图，一天中的时间将更改为该值。                         |
| 64   | Expansion                                             | Integer | 经典旧世：0；TBC：1；WotLK：2                                                                             |
| 65   | RaidOffset                                            | Integer | 副本重置？                                                                                                |
