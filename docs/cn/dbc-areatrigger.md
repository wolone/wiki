...
| 4      | Y                 | Float   |                                                      |
| 5      | Z                 | Float   |                                                      |
| +      | phaseshift        | Integer | wotlk 或大灾变中新增                                 |
| 6      | radius            | Float   | 似乎是以 x,y,z 为中心、size 码为边长的盒子           |
| 7      | box_x             | Float   | 最常用于 size 为 0 时，但并非总是如此                |
| 8      | box_y             | Float   | 最常用于 size 为 0 时，但并非总是如此                |
| 9      | box_z             | Float   | 最常用于 size 为 0 时，但并非总是如此                |
| 10     | box_orientation   | Float   | 最常用于 size 为 0 时，但并非总是如此                |
