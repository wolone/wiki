...
此表包含有关服务端法术的数据，这些法术无法在客户端的 DBC 文件中找到。

**Spell\_Effect\_ID**

- 与 [Effect1、Effect2 和/或 Effect3](spell-effects-reference) 相关的 Effect\_ID。

**Spell\_Effect\_Apply\_Aura_ID**

- 与 [EffectApplyAuraName1、EffectApplyAuraName2 和/或 EffectApplyAuraName3](spell-aura-reference) 相关的 EffectApplyAuraName\_ID。
...
[Effect1、Effect2 和 Effect3。Spell\_Effect 的 Effect\_ID。一个法术最多只能有三个 Spell\_Effects。](spell-effects-reference)
...
[EffectApplyAuraName1、EffectApplyAuraName2 和 EffectApplyAuraName3。Spell\_Effect\_Apply\_Aura 的 EffectApplyAuraName\_ID。](spell-aura-reference)
