...
| ------ | ----------------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1      | ID                      | Integer      | 成就 ID                                                                                                                                                                                                                     |
| 2      | Faction                 | Integer      | -1：两者，0：部落或 1：联盟                                                                                                                                                                                                 |
| 3      | Map                     | Integer      | 仅当成就与某个区域相关时设置，否则设置为 -1                                                                                                                                                                                 |
| 4      | Previous                | Integer      | 如果该成就属于某个系列，这是前一个成就的 ID。否则为 0。                                                                                                                                                                    |
| 5-20   | Name                    | String + Loc |                                                                                                                                                                                                                             |
| 21     | ?                       |              | 似乎总是 0xFF01FE                                                                                                                                                                                                           |
| 22-37  | Description             | String + Loc | 如果描述为空，则它不是成就，而是统计标签页的一部分                                                                                                                                                                          |
| 38     | ?                       |              | 似乎总是 16712190，在少数情况下为 16712188（副本？）                                                                                                                                                                        |
| 39     | Category                | Integer      | 分类 ID                                                                                                                                                                                                                     |
| 40     | Points                  | Integer      | 0,5,10,15,20,25,30,50                                                                                                                                                                                                       |
| 41     | OrderInGroup            | Integer      | 最小值：1                                                                                                                                                                                                                   |
| 42     | Flags                   | Integer      | 0-768，如果为 256，则每个领域只有一个人能达成该成就；如果为 768，则每个领域只有一个团队副本能达成。或许还有第二种分类？                                                                                                      |
| 43     | SpellIcon               | Integer      | 要显示的图标。                                                                                                                                                                                                              |
| 44-59  | Reward                  | String + Loc |                                                                                                                                                                                                                             |
| 47     | Bonus                   |              | 附加奖励文本                                                                                                                                                                                                                |
| 60     | ?                       |              | 浮点数？                                                                                                                                                                                                                    |
| 61     | Demands                 | Integer      | 要获得此成就需要获得/满足的条目数量。例如，如果你需要获得 25 件战袍，这里就是 25。TrinityCore："需要完成的条件数量（自身的或引用的成就条件）"                                                                                  |
| 62     | ReferencedAchievemnt    | Integer      | TrinityCore："引用的成就（统计所有已完成条件的成就）"                                                                                                                                                                       |
