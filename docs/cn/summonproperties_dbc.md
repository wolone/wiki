...
[`返回:法术效果参考`](spell-effects-reference)

[`返回:DBC`](dbc-index)

**\`summonproperties\_dbc\` 表**

该 DBC 包含法术效果 SPELL_EFFECT_SUMMON (28) 的召唤属性（Summon Properties）（EffectMiscValueB）
...
| ------------ | ---- | ---------- | --- | ---- | ------- | ----- | ----------- |
| [ID][1]      | INT  | SIGNED     | PRI | NO   | 0       |       | 唯一 ID     |
| [Control][2] | INT  | SIGNED     |     | NO   | 0       |       |             |
| [Faction][3] | INT  | SIGNED     |     | NO   | 0       |       |             |
| [Title][4]   | INT  | SIGNED     |     | NO   | 0       |       | 召唤类型     |
...
这是来自 SummonProperties.dbc 的 ID。
